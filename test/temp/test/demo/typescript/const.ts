...
export const CHANGE_PROCESS_NODES = [{
  value: $t1('wan_shan_fang_an'),
  text: $t1('wan_shan_fang_an')
}, {
  value: $t1('yuan_chang_ji_shu_shou_quan'),
  text: $t1('yuan_chang_ji_shu_shou_quan')
}, {
  value: $t1('yu_ping_gu'),
  text: $t1('yu_ping_gu')
}, {
  value: $t1('ji_shu_ping_shen'),
  text: $t1('ji_shu_ping_shen')
}, {
  value: $t1('yuan_chang_guan_li_shou_quan'),
  text: $t1('yuan_chang_guan_li_shou_quan')
}, {
  value: $t1('ke_hu_shou_quan'),
  text: $t1('ke_hu_shou_quan')
}, {
  value: $t1('bu_shu_shi_shi'),
  text: $t1('bu_shu_shi_shi')
}, {
  value: $t1('ke_hu_yan_shou'),
  text: $t1('ke_hu_yan_shou')
}, {
  value: $t1('shi_bai_gen_jin'),
  text: $t1('shi_bai_gen_jin')
}];
export const CHANGE_NODES = [{
  id: '1',
  label: $t1('wan_shan_fang_an')
}, {
  id: '9',
  label: $t1('yuan_chang_ji_shu_shou_quan')
}, {
  id: '2',
  label: $t1('yu_ping_gu')
}, {
  id: '10',
  label: $t1('ji_shu_ping_shen')
}, {
  id: '3',
  label: $t1('yuan_chang_guan_li_shou_quan')
}, {
  id: '4',
  label: $t1('ke_hu_shou_quan')
}, {
  id: '5',
  label: $t1('bu_shu_shi_shi')
}, {
  id: '6',
  label: $t1('ke_hu_yan_shou')
},
// { id: '7', label: '结束事件' },
{
  id: '8',
  label: $t1('shi_bai_gen_jin')
}];
...
export const BATCH_ACTIONS_ENUMS = [{
  value: 1,
  text: $t1('pi_liang_shen_pi')
}, {
  value: 2,
  text: $t1('pi_liang_zhuan_dan')
}, {
  value: 3,
  text: $t1('pi_liang_ren_ling')
}, {
  value: 4,
  text: $t1('pi_liang_tiao_guo')
}, {
  value: 5,
  text: $t1('pi_liang_bian_ji')
}, {
  value: 6,
  text: $t1('pi_liang_dao_chu')
}, {
  value: 7,
  text: $t1('pi_liang_chuang_jian')
}];
...
export const CHANGE_STATUS = [{
  value: '0',
  text: $t1('jin_xing_zhong'),
  color: '#22C265'
}, {
  value: '1',
  text: $t1('zheng_chang_jie_shu'),
  color: '#AEAEAE'
}, {
  value: '2',
  text: $t1('yi_chang_zhong_zhi'),
  color: '#E75151'
}];
...
export const CHANGE_TYPES = [{
  value: '0',
  text: $t1('fu_wu_ren_wu')
}, {
  value: '1',
  text: $t1('fu_wu_zi_ren_wu')
}];
...
export const SOURCE_ENUMS = [{
  ...
  value: $t1('yun_wei_zhu_dong_fu_wu'),
  text: $t1('yun_wei_zhu_dong_fu_wu')
}, {
  value: $t1('feng_xian_dan_pai_cha'),
  text: $t1('feng_xian_dan_pai_cha')
}, {
  value: $t1('feng_xian_dan_xiu_fu'),
  text: $t1('feng_xian_dan_xiu_fu')
}, {
  value: $t1('tian_xun'),
  text: $t1('tian_xun')
}, {
